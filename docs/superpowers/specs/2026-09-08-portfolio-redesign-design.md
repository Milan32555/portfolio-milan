...
> Sesión de brainstorming iniciada 2026-09-08. **Actualizado 2026-09-22**: `/servicios`, el footer "Cordilleras" y `/proyectos` ya están cerrados **e implementados en producción** (ver puntos 1, 2 y 4 de Pendiente). Sigue faltando diseñar `/sobre-mi`, el home resumido y el Loader con Three.js — y el rediseño grande del sitio (sidebar fijo + paleta navy + cursor "resplandor etéreo") **todavía no se ha implementado**: lo ya construido (footer, `/proyectos`) vive sobre el diseño viejo actual (navbar superior, `--bg:#0c0c0e`, tema claro/oscuro), no sobre la navy nueva. Retomar leyendo este archivo primero.
